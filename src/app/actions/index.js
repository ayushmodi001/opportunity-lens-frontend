...
export async function generatePersonalizedCourse(topics) {
    ...
    Create 2-3 modules, each with 2-3 chapters. Each chapter should have 2-3 sub-topics Those subtopics should have a link to a valid page like gfg or w3schools for eg a react module would include link to react doc.please make sure the links are latest and new versions as they keep on changing in every few days. make sure to not include legacy docs like here https://legacy.reactjs.org/docs/components-and-props.html.
